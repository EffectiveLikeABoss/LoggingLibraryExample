...
#import "LLSingleLog.h"

@interface LoggingLibrary : NSObject

extern NSString * const LOGGING_LIBRARY_ERROR;
extern NSString * const LOGGING_LIBRARY_INFO;
extern NSString * const LOGGING_LIBRARY_CHECK;
